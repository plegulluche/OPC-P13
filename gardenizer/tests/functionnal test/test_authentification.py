...
class TestAuthentification(StaticLiveServerTestCase):
    ...
    def test_register(self):
        self.assertEqual(self.browser.find_element_by_tag_name("h5").text,"Gardenizer , l'organisateur simple et efficace")
    ...
    def test_login(self):
        ...
        self.assertEqual(self.browser.find_element_by_tag_name('h1').text, "Se connecter")
