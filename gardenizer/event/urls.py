...
urlpatterns = [
    ...
    path('customer-event/<int:eventid>/update',views.update_customer_event_view, name='update_customer_event'),
    path('maintenance-event/<int:eventid>/update',views.update_maintenance_event_view, name='update_maintenance_event'),
